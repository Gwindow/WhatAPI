...
public class PrivateMessage {
	 ...
	 * @param subject  subject of message
	 * @param body     body of the message
	 * @throws CouldNotLoadException if we fail to find the user we're trying to send a PM too
	 */
	 ...
	 * @param convId the conversation id of the conversation the message is for
	 * @param body   body of the message
	 */
	 ...
	 *
	 * @param username recipient user name
	 * @throws CouldNotLoadException if we fail to find the user we're trying to send PM too
	 */
	 ...
	 *
	 * @param subject the subject text to set
	 */
	 ...
	 * Set message body.
	 *
	 * @param body the text to set as the body
	 */
